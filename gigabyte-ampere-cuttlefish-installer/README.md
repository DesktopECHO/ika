...
wget -O preseed-mini.iso.xz "https://artifactregistry.googleapis.com/download/v1/projects/android-cuttlefish-artifacts/locations/us/repositories/gigabyte-ampere-server-installer/files/gigabyte-ampere-cuttlefish-installer:${ARM_OS_IMAGE_VERSION}:preseed-mini.iso.xz:download?alt=media"
```
...
gcloud artifacts versions list \
    ...
    --package=gigabyte-ampere-cuttlefish-installer
```
