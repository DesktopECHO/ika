...
| [`packages-apps-Launcher3-logspam.patch`](packages-apps-Launcher3-logspam.patch) | `packages/apps/Launcher3` | Keeps expected dynamic-display cache rebuild diagnostics behind debug logging instead of reporting normal host resize behavior as Launcher3 errors. |
