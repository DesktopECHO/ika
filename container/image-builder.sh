...
usage() {
  ...
  echo "      stable   - Downloads and installs host RPMs from stable channel"
  echo "      unstable - Downloads and installs host RPMs from unstable channel"
  echo "      nightly  - Downloads and installs host RPMs from nightly channel"
  echo "      dev      - Use *.rpm files under repo dir as prebuilt of host packages"
