...
# crosvm Cargo.lock pins minijail to a Gerrit change ref, not a branch/tag.
readonly MINIJAIL_CROSVM_REV="bfd22f25fd2302fe4ae5121d80c836e0f124e742"
readonly MINIJAIL_CROSVM_REF="refs/changes/50/7093550/3"
